...
def main():
    ...
    try:
        ...
        print("\nStarting ADASYN + Decision Tree fine-tuning...")
        ...
        model_path = os.path.join(
            MODEL_DIR,
            "decision_tree_adasyn_finetuned.pkl"
        )
        ...
        print("\nADASYN + Decision Tree fine-tuning completed successfully.")
