...
# Output directory
MODEL_DIR = "improved_adasyn_xgboost/models"
...
def main():
    ...
    try:
        ...
        #
        # The test set remains untouched during CV and tuning.
        # ---------------------------------------------------------
        ...
        # XGBoost
        #
        # Feature selection and ADASYN are performed separately
        ...
        # ---------------------------------------------------------
        # Reduced XGBoost hyperparameter grid
        #
        # This is intentionally small so the experiment runs
        # faster than the previous large XGBoost search.
        # ---------------------------------------------------------

        parameter_grid = {
            "adasyn__sampling_strategy": [
                0.3,
                0.5
            ],
            "model__n_estimators": [
        ...
        print(
            "\nStarting improved ADASYN + XGBoost fine-tuning..."
        )
        ...
        print("\n")
        print("=" * 60)
        print("IMPROVED ADASYN + XGBOOST TEST RESULTS")
        print("=" * 60)

        print(
            "\nModel:"
            "\nImproved Features + ADASYN + XGBoost"
        )
        ...
        # ---------------------------------------------------------
        # Save improved ADASYN + XGBoost model
        # ---------------------------------------------------------

        model_path = os.path.join(
            MODEL_DIR,
            "improved_adasyn_xgboost.pkl"
        )
        ...
        print("\nImproved ADASYN + XGBoost model saved to:")
        print(
            model_path
        )

        print(
            "\nImproved ADASYN + XGBoost training "
