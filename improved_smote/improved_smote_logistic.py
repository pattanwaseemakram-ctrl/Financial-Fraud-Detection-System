...
# Output directory
MODEL_DIR = "improved_smote/models"
...
def main():
    ...
    try:
        ...
        # Logistic Regression
        #
        # All preprocessing and SMOTE operations are performed
        ...
        print("\nStarting improved SMOTE + Logistic Regression...")
        ...
        print("\n")
        print("=" * 60)
        print("IMPROVED SMOTE + LOGISTIC REGRESSION RESULTS")
        print("=" * 60)
        ...
        print("\nImproved SMOTE model saved to:")
        print(
            model_path
        )

        print(
            "\nImproved SMOTE + Logistic Regression "
