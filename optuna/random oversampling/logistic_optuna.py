...
MODEL_PATH = os.path.join(
    MODEL_DIR,
    "logistic_regression_optuna_v2.pkl"
)
...
DATABASE_PATH = os.path.join(
    OPTUNA_DIR,
    "logistic_regression_optuna_v2.db"
)
...
def objective(trial, X_train, y_train):
    ...
    Optuna searches for the best Logistic Regression
...
def main():
    ...
    try:
        ...
        print("Hyperparameters: C, solver, class_weight")

        # Create Optuna study
        study = optuna.create_study(
            direction="maximize",
            study_name="logistic_regression_random_oversampling_v2",
