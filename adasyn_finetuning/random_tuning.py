...
def main():
    ...
    try:
        ...
        print("\nStarting ADASYN + Random Forest fine-tuning...")
        ...
        model_path = os.path.join(
            MODEL_DIR,
            "random_forest_adasyn_finetuned.pkl"
        )
        ...
        print("\nADASYN + Random Forest fine-tuning completed successfully.")
