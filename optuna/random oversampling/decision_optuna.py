...
def objective(trial, X_train, y_train):
    ...
    Optuna searches for the best Decision Tree
...
def main():
    ...
    try:
        ...
        study = optuna.create_study(
            direction="maximize",
            study_name="decision_tree_random_oversampling_v2",
