...
# Class containing Decision Tree fine-tuning methods
class SMOTEDecisionTreeFineTuner:
    ...
    def save_model(self, model):
        ...
        file_path = os.path.join(
            MODEL_DIR,
            "decision_tree_smote_finetuned.pkl"
        )
...
def main():
    ...
    try:
        ...
        trainer = SMOTEDecisionTreeFineTuner()
