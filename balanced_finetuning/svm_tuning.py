# Random Oversampling + SVM Fine-Tuning
...
MODEL_PATH = os.path.join(
    MODEL_DIR,
    "random_oversampling_svm_finetuned.pkl"
)
...
def main():
    ...
    try:
        ...
        print("\nStarting SVM balanced fine-tuning...")
        ...
        # SVM uses decision_function instead of predict_proba
