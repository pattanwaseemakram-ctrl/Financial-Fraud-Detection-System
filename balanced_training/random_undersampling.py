...
# Folder to save Random Undersampling trained models
MODEL_DIR = (
    "balanced_training/models/random_undersampling"
)


# Class containing all Random Undersampling model training methods
class RandomUndersamplingModelTrainer:
...
# Main function to control the Random Undersampling training workflow
def main():

    try:

        # Create RandomUndersamplingModelTrainer object
        trainer = RandomUndersamplingModelTrainer()

        # Load Random Undersampling training features
        X_train = trainer.load_features(
            X_TRAIN_FILE
        )

        # Load Random Undersampling training target
        ...
        print(
            "Random Undersampling training features shape:",
            X_train.shape
        )

        print(
            "Random Undersampling training target shape:",
            y_train.shape
        )
        ...
        print(
            "\nRandom Undersampling training class distribution:"
        )
        ...
        trainer.save_model(
            logistic_model,
            "logistic_regression_random_undersampling.pkl"
        )
        ...
        trainer.save_model(
            decision_tree_model,
            "decision_tree_random_undersampling.pkl"
        )
        ...
        trainer.save_model(
            random_forest_model,
            "random_forest_random_undersampling.pkl"
        )
        ...
        trainer.save_model(
            xgboost_model,
            "xgboost_random_undersampling.pkl"
        )
        ...
        trainer.save_model(
            knn_model,
            "knn_random_undersampling.pkl"
        )


        print(
            "\nRandom Undersampling model training "
            "and evaluation completed successfully."
        )
